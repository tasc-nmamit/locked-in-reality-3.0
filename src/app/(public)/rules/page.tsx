...
export default function Rules() {
  return (
    <main>
      <div className="px-4 pb-16 pt-32 text-white md:pb-20 md:pt-48">
        <div className="mt-10 flex w-full flex-col items-center gap-10">
          ...
          <div className="w-full max-w-4xl">
            <header className="text-3xl font-semibold md:text-5xl">
              About
            </header>
            <p className="mt-4 text-left">
              Locked in Reality is a high-tech adventure where your wits are
              your only key. As you navigate through a maze of puzzles and
              clues, every step brings you closer to unlocking secrets hidden in
              plain sight. With every challenge, the line between the digital
              and the physical begins to blur, pushing you to think faster, act
              smarter, and uncover the treasure that awaits.
            </p>
          </div>
          <div className="grid w-full max-w-4xl grid-cols-1 lg:grid-cols-2">
            <div>
              ...
              <ul className="mt-2 list-disc pl-8">
                ...
                <li>
                  The questions are divided into levels of increasing
                  difficulty, with higher-difficulty questions offering greater
                  rewards.
                </li>
                <li>
                  Teams can attempt as many questions within the given time
                  limit to maximise their score.
                </li>
                <li>
                ...
                <li>
                  Participants can choose to take hints for challenging
                  questions, but points will be deducted for each hint used.
                </li>
