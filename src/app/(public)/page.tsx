    ...
    <main className="pt-80">
      ...
      <div className="mt-10 flex w-full justify-center gap-4">
        <Button
          ...
          className="rounded-full border-2 border-white/20 bg-gradient-to-r from-slate-950 to-slate-800 p-6 text-xl transition-all duration-300 hover:scale-110 md:p-8 md:text-2xl"
        >
          Rules
        </Button>
        <Button
          onClick={() => router.push("/start")}
          className="rounded-full border-2 border-white/20 bg-gradient-to-r from-purple-900 via-purple-500 to-purple-600 p-6 pr-3 text-xl transition-all duration-300 hover:scale-110 md:p-8 md:pr-5 md:text-2xl"
        >
          Start
